...
var _FormSuggested = _interopRequireDefault(require("lib/FormSuggested"));
...
function getSuggestedValue(field, selectionData, formValues, additionalValues, resources) {
  var value = field.suggestedValue(selectionData, _objectSpread(_objectSpread({}, formValues), additionalValues || {}), resources);
...
function FormElement(_ref) {
  ...
  var suggestedValue = field.suggestedValue ? getSuggestedValue(field, props.selectionData, props.formValues, props.additionalValues, props.resources) : undefined;
    ...
    default:
      if (field.model) {
        return /*#__PURE__*/_react.default.createElement(_Autocomplete.default, {
          ...
          defaultValue: props.resource ? (0, _lodash.default)(props.resource).get(field.editValue) || null : null,
