...
function ResourcesModalForm(props) {
  ...
  var form = (0, _formik.useFormik)({
    initialValues: (0, _lodash.default)(fieldNames).zipObject().mapValues(function (_v, k) {
      return resource ? _lodash.default.get(resource, k) : '';
    }).value(),
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 6;
                return (_props$model = props.model).create.apply(_props$model, _toConsumableArray(props.routeParams || []).concat(_toConsumableArray(props.parentSelections || []), [values, props.externalState]));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = 7;
                return (_props$model2 = props.model).edit.apply(_props$model2, [resource_id, values].concat(_toConsumableArray(props.routeParams || []), _toConsumableArray(props.parentSelections || [])));
