      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (_props$model = props.model).remove.apply(_props$model, _toConsumableArray(props.routeParams || []).concat(_toConsumableArray(props.parentSelections || []), [resource.id]));
...
function renderField(row, field) {
  ...
  switch (field.type) {
    ...
    case 'boolean':
      return value ? /*#__PURE__*/_react.default.createElement(_icons.Check, null) : /*#__PURE__*/_react.default.createElement(_icons.Clear, null);
...
function ResourcesAsTable(_ref) {
  ...
  , {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, {
      ...
      resource: r,
      resources: resources,
      buttonComponent: /*#__PURE__*/_react.default.createElement(_core.IconButton, {
        color: "inherit",
        variant: "contained"
      ...
      color: "inherit",
      variant: "contained"
    }, /*#__PURE__*/_react.default.createElement(_ModalDeleteConfirm.default, _extends({
      removeResource: removeResource,
      r: r,
      enqueueSnackbar: enqueueSnackbar,
      setSelected: setSelected
    }, props))), props.nestedResourceActions && (0, _lodash.default)(props.nestedResourceActions).map(function (_ref2) {
      var Icon = _ref2.icon,
          a = _objectWithoutProperties(_ref2, ["icon"]);

      return /*#__PURE__*/_react.default.createElement(_core.IconButton, {
        color: "inherit",
        variant: "contained",
        onClick: function onClick(e) {
          return a.onClick(e, r);
        }
      }, /*#__PURE__*/_react.default.createElement(_core.Tooltip, {
        title: a.tooltip
      }, /*#__PURE__*/_react.default.createElement(Icon, null)));
    }).value()))), props.afterRow && /*#__PURE__*/_react.default.createElement(_core.TableRow, null, /*#__PURE__*/_react.default.createElement(_core.TableCell, {
    ...
    variant: "caption"
  }, " No hay datos"))))), allowCreation && !props.hideAddButton && /*#__PURE__*/_react.default.createElement(_ResourcesModalForm.default, _extends({
    resources: resources,
    setSelected: setSelected
  }, props))));
}
