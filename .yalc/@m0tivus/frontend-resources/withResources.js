...
var withResources = function withResources(WrappedElement) {
  var WithResources = function WithResources(props) {
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  return _context.abrupt("return", (_props$model = props.model).all.apply(_props$model, _toConsumableArray(props.routeParams || []).concat(_toConsumableArray(props.parentSelections || []))));
    ...
    _react.default.useEffect(fetchData, [props.enoughSelections, props.externalState].concat(_toConsumableArray(props.routeParams || []), _toConsumableArray(props.parentSelections)));
